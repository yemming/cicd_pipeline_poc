...
import { deleteStoreAction } from "@/lib/rbac/org-actions";
...
const storeColumns: DataGridColumn<Row>[] = [
  ...
  },
  {
    ...
    width: 220,
    cell: (r) => (
      <Link href={`/admin/org/stores/${r.id}`} className="font-medium text-[#185FA5] hover:underline">
        {r.name}
        {r.short_name && (
      ...
      <section className="bg-white border border-[#EEECE6] rounded-lg px-4 py-3">
        <div className="flex gap-2 items-end flex-wrap">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <button
              type="button"
              onClick={() => router.push("/admin/org/stores/new")}
      ...
      <DataGrid<Row>
        ...
        rowActions={(r) => (
          <>
            <button
              type="button"
              onClick={() => router.push(`/admin/org/stores/${r.id}`)}

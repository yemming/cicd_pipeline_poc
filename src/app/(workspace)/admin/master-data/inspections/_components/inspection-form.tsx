...
function utcToLocalInput(iso: string | null | undefined): string {
  ...
  // toISOString gives UTC; we want Asia/Taipei display in datetime-local format
...
export function InspectionForm({
  ...
  const findingsJson = useMemo(() => JSON.stringify(findings), [findings]);
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <input type="hidden" name="findings_json" value={findingsJson} />

/**
 * 售後電訪任務 Detail Page
 * Thin re-export：reuse sales 版 CallTaskDetailView，basePath 指 aftersales。
 */
...
import { CallTaskDetailView } from "../../../../sales/crm/call-tasks/[id]/_components/call-task-detail-view";

export const dynamic = "force-dynamic";

const BASE_PATH = "/aftersales/crm/call-tasks";

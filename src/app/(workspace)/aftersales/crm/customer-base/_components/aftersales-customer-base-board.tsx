...
export function AftersalesCustomerBaseBoard({
  ...
  const submitFilters = () => {
    ...
    startTransition(() => {
      router.push(
        qs ? `/aftersales/crm/customer-base?${qs}` : "/aftersales/crm/customer-base",
      );
    });
  };
  const resetFilters = () => {
    ...
    setFType("all");
    setFQ("");
    startTransition(() => router.push("/aftersales/crm/customer-base"));
  };
  ...
  const columns: DataGridColumn<AftersalesCustomerBaseRow>[] = [
    {
      ...
      cell: (r) => (
        <Link
          href={`/aftersales/crm/customer-base/${r.id}`}
      ...
      >
        <div className="flex gap-2 items-end flex-wrap">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <Link
              href="/aftersales/crm/customer-base/new"

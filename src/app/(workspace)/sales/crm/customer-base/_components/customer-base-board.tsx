...
export function CustomerBaseBoard({
  ...
  const submitFilters = () => {
    ...
    startTransition(() => {
      router.push(
        qs ? `/sales/crm/customer-base?${qs}` : "/sales/crm/customer-base",
      );
    });
  };
  const resetFilters = () => {
    ...
    setFStatus("all");
    setFQ("");
    startTransition(() => router.push("/sales/crm/customer-base"));
  };
  ...
  const columns: DataGridColumn<CustomerBaseRow>[] = [
    {
      ...
      cell: (r) => (
        <Link
          href={`/sales/crm/customer-base/${r.id}`}
      ...
      >
        <div className="flex gap-2 items-end flex-wrap">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <Link
              href="/sales/crm/customer-base/new"

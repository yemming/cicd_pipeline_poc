...
import { StoreOverviewView } from "./_components/store-overview-view";
...
export default async function Page({
  ...
  if (!(await hasPermission(PERMISSIONS.CUSTOMER_VIEW))) {
    return (
      <main className="px-6 py-6">
        <p className="text-[14px] text-[#BF2600]">沒有檢視門店綜合概覽的權限</p>
      </main>
    );
  }
  ...
  return <StoreOverviewView data={data} range={range} />;
}

...
import { getReconWorkorderData } from "@/domain/recon-workorder";

import { ReconWorkorderView } from "./_components/recon-workorder-view";

export const dynamic = "force-dynamic";

export default async function ReconWorkorderPage({
  params,
}: {
  ...
  const data = await getReconWorkorderData(id);
  if (!data) notFound();
  ...
  return <ReconWorkorderView data={data} canExecute={canExecute} canApprove={canApprove} />;
}

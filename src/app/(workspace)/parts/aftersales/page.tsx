...
/**
 * /parts/aftersales — 售後修護模組導覽 / 流程關係圖 landing page
 *
 * 對應設計稿：docs/DUCATI_售後工單模組_完整且含串接庫存版_20260510_最新版/00_售後工單模組_流程關係圖.html
 * 來源 nav_node：indian 9c4db4e6-… / ducati 19bcc529-…（雙 brand 都升級）
 *
 * 結構：
...
export default async function AftersalesFlowDiagramPage() {
